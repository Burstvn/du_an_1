...
//thêm sản phẩm
function add_product($cate_id, $name, $description, $image, $detail, $price, $sale, $status, $create)
{
    $data = [
        'cate_id' => $cate_id,
        'name' => $name,
...
function list_product_categories($id)
{
...
//top 4 sản phẩm xem nhiều nhất
function list_top_product()
{
